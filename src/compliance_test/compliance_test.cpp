  ...
  tf_listener_(tf_buffer_)
{
  ...
  jog_arm_warning_sub_ = n_.subscribe("jog_arm_server/halted", 1, &compliance_class::halt_cb, this);
...
void compliance_test::compliance_class::halt_cb(const std_msgs::Bool::ConstPtr& msg)
{
...
void compliance_test::compliance_class::ft_cb(const geometry_msgs::WrenchStamped::ConstPtr& msg)
{
  ft_data_ = *msg;
